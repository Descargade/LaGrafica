...
function Home() {
  useEffect(() => {
    const items = document.querySelectorAll('.la-grafica-current .reveal-on-scroll');
  ...
  return <div className="la-grafica-current grain min-h-screen min-h-[100dvh] bg-[#1a1a1a]"><Header /><main><Hero /><Services /><Works /><Products /><About /><QuoteForm /></main><Footer /></div>;
}
